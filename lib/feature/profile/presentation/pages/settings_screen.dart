...
import 'package:elia/feature/profile/domain/models/theme_preference.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _SectionLabel('Appearance', color: AppColors.textMuted),
              ...
              const SizedBox(height: 24),
              _SectionLabel('My Language', color: AppColors.textMuted),
              const SizedBox(height: 10),
              _SettingsGroup(
                backgroundColor: AppColors.surface,
                borderColor: AppColors.surfaceBorder,
              ...
              const SizedBox(height: 24),
              _SectionLabel('Audio', color: AppColors.textMuted),
              const SizedBox(height: 10),
              _SettingsGroup(
                backgroundColor: AppColors.surface,
                borderColor: AppColors.surfaceBorder,
              ...
              const SizedBox(height: 24),
              _SectionLabel('Privacy', color: AppColors.textMuted),
              const SizedBox(height: 10),
              _SettingsGroup(
                backgroundColor: AppColors.surface,
                borderColor: AppColors.surfaceBorder,
              ...
              const SizedBox(height: 24),
              _SectionLabel('About', color: AppColors.textMuted),
              const SizedBox(height: 10),
              _SettingsGroup(
                backgroundColor: AppColors.surface,
                borderColor: AppColors.surfaceBorder,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text(value, style: TextStyle(color: AppColors.textMuted, fontSize: 14)),
        ],
      ),
    );
  }
